...
namespace proyecto_final_PED
{
    public partial class Form2 : Form
    {
        ...
        {
            AgregarProductos agregarProductos = new(repo);

            // Mostrar el formulario
            agregarProductos.Show();
        }

        private void eliminarProductosbtn_Click(object sender, EventArgs e)
        {
            EliminarProductos eliminarProductos = new EliminarProductos(repo);
...
private void crearpreguntabtn_Click(object sender, EventArgs e)
{
  ...
  Productos nuevaPregunta = new Productos(Guid.NewGuid(), textoPregunta, respuesta1, respuesta2, respuesta3, respuesta4, respuestaCorrecta, asignatura, unidad, subunidad);
...
private void borrarPregbtn_Click(object sender, EventArgs e)
{
  if (dataGridView1.SelectedRows.Count > 0)
  {
      ...
      Productos preguntaSeleccionada = filaSeleccionada.DataBoundItem as Productos;
  ...
  if (dataGridView1.SelectedRows.Count > 0)
  {
      ...
      if (preguntaSeleccionada != null)
      {
          ...
          if (resultado == DialogResult.Yes)
          {
              ...
              Productos nuevaPregunta = new Productos(
